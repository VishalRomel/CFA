...
function LatestEvent() {
  ...
  return (
    <section id="second-section" className="relative p-20 bg-transparent overflow-hidden">
      <div className="absolute   inset-0 z-0 pointer-events-none"> {/* Add pointer-events-none class */}
  ...
  <img className="w-full max-w-md rounded-lg mr-10" src={Upcoming_event1} alt="Latest Event" />

  <p className="text-lg font-mono items-center h-1/2 ">Hello everyone!

Are you aiming for a career in Software Engineering or looking to dive into the Research Field or 
just looking for internships that could kickstart your journey in the tech industry? Don’t miss this
unique opportunity to meet Allen Kim, a PhD Meta Research Scientist, on April 17th.
</p>
